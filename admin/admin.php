...
<div class="container">
    ...
    <form method="post" action="calculate_daily_earnings.php">
        <button type="submit" name="percentage" value="0.0035" class="btn btn-primary">Earn 0.35%</button>
        <button type="submit" name="percentage" value="0.0045" class="btn btn-primary">Earn 0.45%</button>
        <button type="submit" name="percentage" value="0.0055" class="btn btn-primary">Earn 0.65%</button>
    </form>
</div>
